document.addEventListener('DOMContentLoaded', () => {
    ...
    const eventsData = [
        // JULHO
        { date: '2025-07-05', type: 'ATIVIDADE', title: 'Instalação da Gestão', description: 'Cerimônia de Instalação da 29ª Gestão do Capítulo Mozart Vallim.', local: 'Loja Maçônica', responsavel: 'Diretoria', tags: ['evento', 'instalação', 'gestão'] },
        { date: '2025-07-19', type: 'ATIVIDADE', title: 'Reunião Ritualística', description: 'Apresentação e definição dos membros das Comissões Permanentes da gestão.', local: 'Loja Maçônica', responsavel: 'Mestre Conselheiro', tags: ['administrativo', 'comissões'] },
        { date: '2025-07-26', type: 'ATIVIDADE', title: 'Reunião Ritualística', description: 'Apresentação e aprovação do calendário oficial da 29ª Gestão.', local: 'Loja Maçônica', responsavel: 'Mestre Conselheiro', tags: ['planejamento', 'gestão', 'calendário'] },
        ...
        // SETEMBRO
        { date: '2025-09-06', type: 'ATIVIDADE', title: 'Ano DeMolay', description: 'Atividade relacionada com o Tema Anual “Juventude e Futuro: A Ordem DeMolay diante da Inteligência Artificial”.', local: 'Loja Maçônica Cavaleiros de Malta', responsavel: 'Comissão', tags: ['educacional', 'tecnologia', 'CNIE'] },
        ...
        { date: '2025-09-21', type: 'ATIVIDADE', title: 'Porco no Rolete', description: 'Principal evento de arrecadação de fundos da gestão.', local: 'CTG', responsavel: 'Comissão', tags: ['filantropia', 'comunidade', 'CNIE'] },
        ...
        { date: '2025-10-25', type: 'EVENTO', title: 'Festa de 14 Anos', description: 'Evento comemorativo pelo aniversário de 14 anos do Capítulo Mozart Vallim.', local: 'A definir', responsavel: 'Comissão', tags: ['comemoração', 'festa', 'aniversário'] },
        ...
        { date: '2025-11-15', type: 'ATIVIDADE', title: 'Eleição para 30ª Gestão', description: 'Realização das eleições para a próxima diretoria do Capítulo.', local: 'Loja Maçônica', responsavel: 'Comissão', tags: ['eleição', 'administrativo', 'gestão'] },
        ...
        // DEZEMBRO
        { date: '2025-12-06', type: 'ATIVIDADE', title: 'Dia do Conforto', description: 'Visita a um asilo, orfanato ou entidade similar, promovendo bem-estar e empatia.', local: 'Asilo ou Orfanato', responsavel: 'Comissão', tags: ['filantropia', 'social', 'CNIE'] },
    ...
    // A renderização inicial agora mostra TODOS os eventos, ordenados por data.
    const allEventsSorted = [...eventsData].sort((a, b) => new Date(a.date) - new Date(b.date));
